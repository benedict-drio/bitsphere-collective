...
app.get('/health', (req: Request, res: Response) => {
  res.status(200).json({ 
    status: 'ok',
    timestamp: new Date().toISOString(),
    contract: 'SP3P2G9ZK7B309EGAM9QAM143YGDNBGGQAXDAS1GW.bitsphere-collective'
  });
});

// Start server
app.listen(PORT, () => {
  console.log(`🚀 BitSphere Webhook Server running on port ${PORT}`);
  console.log(`📡 Listening for events from: SP3P2G9ZK7B309EGAM9QAM143YGDNBGGQAXDAS1GW.bitsphere-collective`);

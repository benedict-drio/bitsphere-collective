# BitSphere Collective - Monitoring Setup

## 🚨 Critical: Your Contract is Live on Mainnet

**Contract Address:** `SP3P2G9ZK7B309EGAM9QAM143YGDNBGGQAXDAS1GW.bitsphere-collective`
...
curl -X POST http://localhost:3000/events/member-joined \
  ...
  -d '{
    "member": "SP3P2G9ZK7B309EGAM9QAM143YGDNBGGQAXDAS1GW",
    "amount": 5000000,
    "block": 12345
  }'
```
...
- Contract on Explorer: <https://explorer.hiro.so/txid/SP3P2G9ZK7B309EGAM9QAM143YGDNBGGQAXDAS1GW.bitsphere-collective?chain=mainnet>
